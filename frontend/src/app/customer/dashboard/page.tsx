...
export default function CustomerDashboardPage() {
        ...
        if (recentOrdersRes.data) {
          ...
          setRecentOrders(recentOrdersRes.data.map((o: any) => {
            ...
            return {
              ...
              item_count: items.reduce((acc: number, curr: { quantity: number }) => acc + curr.quantity, 0),
            };
          }));
        }
      } catch (err) {
  ...
  const quickLinks = [
    {
      title: "My Orders",
      desc: "Track delivery details and view order invoice history",
      href: "/customer/orders",
      icon: <ClipboardList className="h-5 w-5 text-purple-650" />,
    },
    {
      title: "My Profile",
      ...
      <div className="space-y-6 font-sans select-none pb-12">
        ...
        <div className="relative overflow-hidden bg-linear-to-r from-purple-600 to-indigo-650 text-white p-6 rounded-2xl shadow-sm border border-purple-500/10 flex flex-col md:flex-row justify-between md:items-center gap-4">
          <div className="space-y-1 z-10">
            <h1 className="text-xl md:text-2xl font-bold font-heading flex items-center gap-2">
              ...
              Hello, {profile?.full_name || "Guest Customer"}!
            </h1>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-card border border-border p-5 rounded-2xl flex items-center gap-4 shadow-sm">
            ...
            <div>
              <p className="text-[10px] text-muted-foreground font-bold uppercase select-none">Total Invoices</p>
          ...
          <div className="bg-card border border-border p-5 rounded-2xl flex items-center gap-4 shadow-sm">
            ...
            <div>
              <p className="text-[10px] text-muted-foreground font-bold uppercase select-none">Active Shipments</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between border-b border-border pb-2.5">
              ...
              <Link href="/customer/orders" className="text-xs font-bold text-purple-650 hover:underline flex items-center gap-0.5">
                View All Invoices
            ...
            {recentOrders.length === 0 ? (
              <div className="text-center py-12 bg-card border border-border border-dashed rounded-2xl space-y-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-0.5">Your invoices will display here once you place orders.</p>
                </div>
              </div>
            ) : (
          ...
          <div className="space-y-4">
            <h3 className="font-heading font-bold text-sm text-foreground flex items-center gap-1.5 border-b border-border pb-2.5">
              <Settings className="h-4.5 w-4.5 text-purple-650" />
